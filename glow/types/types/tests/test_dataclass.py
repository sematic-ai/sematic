...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            B,
            False,
            "Cannot cast <class 'glow.types.types.tests.test_dataclass.A'> to <class 'glow.types.types.tests.test_dataclass.B'>: missing fields: {'b'}",  # noqa: E501
        ),
        (
            A,
            C,
            False,
            "Cannot cast <class 'glow.types.types.tests.test_dataclass.A'> to <class 'glow.types.types.tests.test_dataclass.C'>: field 'a' cannot cast: <class 'int'> cannot cast to str",  # noqa: E501
        ),
        (
            C,
            A,
            False,
            "Cannot cast <class 'glow.types.types.tests.test_dataclass.C'> to <class 'glow.types.types.tests.test_dataclass.A'>: field 'a' cannot cast: Cannot cast <class 'str'> to int",  # noqa: E501
        ),
        (D, A, True, None),
        (
            A,
            D,
            False,
            "Cannot cast <class 'glow.types.types.tests.test_dataclass.A'> to <class 'glow.types.types.tests.test_dataclass.D'>: missing fields: {'d'}",  # noqa: E501
        ),
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            None,
            None,
            "Cannot cast A(a=1) to <class 'glow.types.types.tests.test_dataclass.B'>: Field 'b' is missing",  # noqa: E501
        ),
        ...
        (
            ...
            None,
            None,
            "Cannot cast C(a='abc') to <class 'glow.types.types.tests.test_dataclass.A'>: Cannot cast 'abc' to <class 'int'>",  # noqa: E501
        ),
    ),
)
...
def test_type_to_json_encodable():
    assert type_to_json_encodable(A) == {
        "type": (
            ...
            "A",
            {
                "import_path": "glow.types.types.tests.test_dataclass",
