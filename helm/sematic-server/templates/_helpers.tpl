...
*/}}
{{- define "sematic-server.fullname" -}}
...
app.kubernetes.io/name: {{ include "sematic-server.name" . }}
...
*/}}
{{- define "sematic-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "sematic-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
