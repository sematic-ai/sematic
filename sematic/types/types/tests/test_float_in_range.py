...
from sematic.types.generic_type import GenericMeta
from sematic.types.serialization import (
    value_from_json_encodable,
    type_to_json_encodable,
)
from sematic.types.types.float_in_range import FloatInRange
...
def test_type_serialization_subclass():
    ...
    assert json_encodable == {
        "type": (
            "class",
            "Probability",
            {"import_path": "sematic.types.types.tests.test_float_in_range"},
        ),
        "registry": {
            "Probability": [
                (
